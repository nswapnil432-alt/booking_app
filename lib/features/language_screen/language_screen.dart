...
class LanguageScreen extends StatelessWidget {
  ...
  LanguageScreen({super.key}) {
    final currentLang = _localizationManager.currentLocale.languageCode;
    String initialLang = 'marathi';
    if (currentLang == 'en') {
      initialLang = 'english';
    } else if (currentLang == 'mr') {
      initialLang = 'marathi';
    }
    selectedLanguage = ValueNotifier<String>(initialLang);
  }
  ...
  final List<LanguageOption> languages = [
    LanguageOption(
      ...
      textColor: AppColors.mlaThemeColor,
    ),
    LanguageOption(
      id: 'marathi',
      name: 'Marathi',
                            ...
                            return Padding(
                              ...
                              child: _buildLanguageCard(
                                ...
                                () async {
                                  ...
                                  // Add a small delay to allow the UI to show the selection before rebuilding
